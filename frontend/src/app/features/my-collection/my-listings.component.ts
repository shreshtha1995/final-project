...
import { PostingManagementService } from '../list-room/posting-management.service';
...
export class MyListingsComponent implements OnInit {
  private postingService = inject(MyListingService);
  private postingMgmt = inject(PostingManagementService);
  ...
  reconfirm(id: number): void {
    this.postingMgmt.confirm(id).subscribe(() => {
